...
URL Source: https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/backend-tool-rendering

Published Time: Thu, 02 Apr 2026 17:01:13 GMT
...
Before you begin, ensure you have completed the [Getting Started](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/getting-started) tutorial and have:
...
*   **[Frontend tools](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/frontend-tools)**: Add frontend tools.

*   **[Test with Dojo](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/testing-with-dojo)**: Use AG-UI's Dojo app to test your agents

*   [AG-UI Overview](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/)
*   [Getting Started Tutorial](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/getting-started)
*   [Agent Framework Documentation](https://learn.microsoft.com/en-us/agent-framework/overview/)
...
These samples use `DefaultAzureCredential` for authentication. Make sure you're authenticated with Azure (e.g., via `az login`). For more information, see the [Azure Identity documentation](https://learn.microsoft.com/en-us/python/api/azure-identity/azure.identity.defaultazurecredential).
...
*   **[Create Advanced Tools](https://learn.microsoft.com/en-us/agent-framework/agents/tools/function-tools)**: Learn more about creating function tools with Agent Framework

*   [AG-UI Overview](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/)
*   [Getting Started with AG-UI](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/getting-started)
*   [Function Tools Tutorial](https://learn.microsoft.com/en-us/agent-framework/agents/tools/function-tools)

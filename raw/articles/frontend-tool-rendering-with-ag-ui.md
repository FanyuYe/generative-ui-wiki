...
URL Source: https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/frontend-tools
...
2.   Sends the tools with each request to the server agent which maps them to `ChatAgentRunOptions.ChatOptions.Tools`
...
*   **[Combine with Backend Tools](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/backend-tool-rendering)**: Use both frontend and backend tools together
...
*   **[Backend Tool Rendering](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/backend-tool-rendering)**: Combine with server-side tools

...
URL Source: https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/
...
1.   **[Getting Started](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/getting-started)**: Build your first AG-UI server and client
2.   **[Backend Tool Rendering](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/backend-tool-rendering)**: Add function tools to your agents
3.   **[Human-in-the-Loop](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/human-in-the-loop)**: Implement approval workflows
4.   **[State Management](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/state-management)**: Synchronize state between client and server
...
1.   **[Getting Started](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/getting-started)**: Build your first AG-UI server and client
2.   **[Backend Tool Rendering](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/backend-tool-rendering)**: Add function tools to your agents
3.   **[Workflows](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/workflows)**: Expose multi-agent workflows through AG-UI
4.   **[Human-in-the-Loop](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/human-in-the-loop)**: Implement approval workflows
5.   **[MCP Apps Compatibility](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/mcp-apps)**: Use MCP Apps with your AG-UI endpoint
6.   **[State Management](https://learn.microsoft.com/en-us/agent-framework/integrations/ag-ui/state-management)**: Synchronize state between client and server
